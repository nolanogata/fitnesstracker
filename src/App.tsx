...
import { chainCategories } from "./data/seeds/foods/catalogRegistry";
...
const appUpdates: AppUpdate[] = [
  ...
  },
  {
    ...
    date: "2026-07-16",
    items: [
      "モスバーガー、ケンタッキー、タリーズを最新の公式栄養資料に合わせて更新しました。",
      "コンビニは公式ページで商品名と栄養値を確認できる定番商品に整理し、汎用的な推定商品を各社の現行商品として表示しないようにしました。",
      "ティーヌンをチェーン一覧から選べるようにし、登録ブランドの確認状況と更新期限を管理する仕組みを追加しました。",
    ],
  },
  {
    id: "2026-07-15-sukiya-refresh",
    title: "すき家のメニューを更新",
    date: "2026-07-15",
    items: [
      "すき家の丼、定食、朝食、サイド、ドリンクを最新の公式栄養資料に合わせて更新しました。",
      "サイズ違いを同じメニューから正しい栄養値で選べるように整理しました。",
    ],
  },
  {
    id: "2026-07-14-report-coverage-and-icecream",
    title: "AI相談とフード候補を改善",
    date: "2026-07-14",
    items: [
      "食事未記録日を0kcalとして扱わず、AI相談前にその日の食事量を簡単に補足できるようにしました。",
      "チェーンのおすすめ組み合わせから、時間帯や販売形態が合わない候補を除外しました。",
      "サーティワンのフレーバー、サイズ、カップ・コーンの違いを記録できるようにしました。",
    ],
  },
  {
    id: "2026-07-13-activity-profile",
    title: "活動量をゴールとAI相談に反映",
    date: "2026-07-13",
    items: [
      "普段の歩数、ムーブ、運動時間などを活動量プロフィールとして任意設定できるようにしました。",
      "AI相談で対象日の活動量と、途中経過・1日全体を選べるようにしました。",
      "初期セットアップをWelcomeから始め、バックアップ復元と活動量設定を選べる流れに改善しました。",
    ],
  },
  {
    id: "2026-07-12-report-and-menu-accuracy",
    title: "推定値の説明とメニュー計算を改善",
    date: "2026-07-12",
    items: [
      "公式kcalと推定PFC、摂取量推定、構成量推定を分けてAI相談レポートへ出力するようにしました。",
      "採用値の残りと安全側の追加目安を分け、Pの達成状況を誤解しにくい表現にしました。",
      "ウエストの公式カロリー対応を広げ、マンマパスタの標準量と大盛り計算を修正しました。",
    ],
  },
  {
    id: "2026-07-11-character-unlock-flow",
    title: "テーマキャラの達成演出を追加",
    date: "2026-07-11",
    items: [
      "達成度が次の段階へ進む時に、連打でパワーを送って新しい背景を開く演出を追加しました。",
      "テーマ設定を独立させ、テーマカラー、キャラ、今後の衣装バリエーションを選びやすい構成にしました。",
      "全画面の入力中は下部ナビを隠し、操作ボタンと重ならないようにしました。",
    ],
  },
  {
