...
export const snackDrinkFoods = [
  ...
  packaged({ brand: "雪印メグミルク", name: "雪印北海道100 さけるチーズ プレーン", category: "おかず・惣菜", tags: ["チーズ", "さけるチーズ", "おつまみ", "個包装", "間食", "炭水化物範囲上限"], calories: 80, protein_g: 6.8, fat_g: 5.7, carbs_g: 0.9, salt_g: 0.49, serving_label: "1本 25g", source_url: "https://www.meg-snow.com/products/detail.php?p=sakerucheese", fetched_at: cheeseSnackFetchedAt }),
  packaged({ brand: "雪印メグミルク", name: "雪印北海道100 さけるチーズ スモーク味", category: "おかず・惣菜", tags: ["チーズ", "さけるチーズ", "スモーク", "おつまみ", "個包装", "間食", "炭水化物範囲上限"], calories: 80, protein_g: 6.8, fat_g: 5.7, carbs_g: 0.9, salt_g: 0.49, serving_label: "1本 25g", source_url: "https://www.meg-snow.com/products/detail.php?p=sakerucheese_smoke", fetched_at: cheeseSnackFetchedAt }),
  packaged({ brand: "雪印メグミルク", name: "雪印北海道100 さけるチーズ とうがらし味", category: "おかず・惣菜", tags: ["チーズ", "さけるチーズ", "とうがらし", "おつまみ", "個包装", "間食", "炭水化物範囲上限"], calories: 80, protein_g: 6.8, fat_g: 5.7, carbs_g: 0.9, salt_g: 0.49, serving_label: "1本 25g", source_url: "https://www.meg-snow.com/products/detail.php?p=sakerucheese_chili", fetched_at: cheeseSnackFetchedAt }),
  packaged({ brand: "雪印メグミルク", name: "雪印北海道100 さけるチーズ ローストガーリック味", category: "おかず・惣菜", tags: ["チーズ", "さけるチーズ", "ガーリック", "おつまみ", "個包装", "間食", "炭水化物範囲上限"], calories: 80, protein_g: 6.8, fat_g: 5.7, carbs_g: 0.9, salt_g: 0.49, serving_label: "1本 25g", source_url: "https://www.meg-snow.com/products/detail.php?p=sakerucheese_garlic", fetched_at: cheeseSnackFetchedAt }),
  packaged({ brand: "雪印メグミルク", name: "雪印北海道100 さけるチーズ バター醤油味", category: "おかず・惣菜", tags: ["チーズ", "さけるチーズ", "バター醤油", "おつまみ", "個包装", "間食", "炭水化物範囲上限"], calories: 80, protein_g: 6.8, fat_g: 5.7, carbs_g: 0.9, salt_g: 0.49, serving_label: "1本 25g", source_url: "https://www.meg-snow.com/products/detail.php?p=sakerucheese_buttersyouyu", fetched_at: cheeseSnackFetchedAt }),
  packaged({ brand: "雪印メグミルク", name: "雪印北海道100 さけるチーズ コンソメ味", category: "おかず・惣菜", tags: ["チーズ", "さけるチーズ", "コンソメ", "おつまみ", "個包装", "間食", "炭水化物範囲上限"], calories: 80, protein_g: 6.8, fat_g: 5.7, carbs_g: 0.9, salt_g: 0.49, serving_label: "1本 25g", source_url: "https://www.meg-snow.com/products/detail.php?p=sakerucheese_consomme", fetched_at: cheeseSnackFetchedAt }),
  ...
  packaged({ brand: "Belcube", name: "ベルキューブ 人気のフレーバーセレクト", category: "おかず・惣菜", tags: ["チーズ", "ベルキューブ", "おつまみ", "個包装", "間食", "100g換算"], calories: 12, protein_g: 0.6, fat_g: 0.8, carbs_g: 0.4, salt_g: 0.10, serving_label: "1個 約5.2g", source_url: "https://www.bel-japon.com/belcube/product/", fetched_at: cheeseSnackFetchedAt }),
  packaged({ brand: "Belcube", name: "ベルキューブ チーズ好きのためのセレクト", category: "おかず・惣菜", tags: ["チーズ", "ベルキューブ", "ブルーチーズ", "チェダー", "カマンベール", "おつまみ", "個包装", "間食", "100g換算"], calories: 11, protein_g: 0.6, fat_g: 0.7, carbs_g: 0.6, salt_g: 0.11, serving_label: "1個 約5.2g", source_url: "https://www.bel-japon.com/belcube/product/", fetched_at: cheeseSnackFetchedAt }),
  packaged({ brand: "Belcube", name: "ベルキューブ イタリアンセレクト", category: "おかず・惣菜", tags: ["チーズ", "ベルキューブ", "トマト", "オリーブ", "生ハム風味", "おつまみ", "個包装", "間食", "100g換算"], calories: 12, protein_g: 0.6, fat_g: 0.8, carbs_g: 0.5, salt_g: 0.11, serving_label: "1個 約5.2g", source_url: "https://www.bel-japon.com/belcube/product/", fetched_at: cheeseSnackFetchedAt }),
  packaged({ brand: "Belcube", name: "ベルキューブ クリーミープレーン", category: "おかず・惣菜", tags: ["チーズ", "ベルキューブ", "クリーミープレーン", "おつまみ", "個包装", "間食", "100g換算"], calories: 13, protein_g: 0.6, fat_g: 0.9, carbs_g: 0.4, salt_g: 0.09, serving_label: "1個 約5.2g", source_url: "https://www.bel-japon.com/belcube/product/", fetched_at: cheeseSnackFetchedAt }),
