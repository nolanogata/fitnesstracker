...
export const proteinProductFoods = [
  ...
  estimatedProduct({ brand: "森永製菓", name: "inバー プロテイン ベイクドチョコ", category: "プロテイン", tags: ["プロテインバー", "inバー"], calories: 210, protein_g: 16, fat_g: 11, carbs_g: 13, serving_label: "1本", source_url: morinagaBarSource }),
  estimatedProduct({ brand: "森永製菓", name: "inバー プロテイン ザクザクチョコ", category: "プロテイン", tags: ["プロテインバー", "inバー"], calories: 220, protein_g: 16, fat_g: 12, carbs_g: 15, serving_label: "1本", source_url: morinagaBarSource }),
  estimatedProduct({ brand: "森永製菓", name: "inバー プロテイン ウェファーバニラ", category: "プロテイン", tags: ["プロテインバー", "inバー"], calories: 200, protein_g: 10, fat_g: 11, carbs_g: 16, serving_label: "1本", source_url: morinagaBarSource }),
];
