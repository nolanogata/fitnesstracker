...
export const genericFoods = [
  ...
  estimated({ name: "プロテイン", category: "サプリ", tags: ["タンパク質"], calories: 120, protein_g: 24, fat_g: 2, carbs_g: 3, serving_label: "1杯" }),
  estimated({ name: "プロテインバー", category: "サプリ", tags: ["タンパク質", "間食"], calories: 200, protein_g: 15, fat_g: 8, carbs_g: 18, serving_label: "1本" }),
