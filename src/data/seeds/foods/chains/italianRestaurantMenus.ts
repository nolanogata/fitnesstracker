...
export const italianRestaurantMenuFoods = [
  ...
  item({ brand: "マンマパスタ", name: "ペスカトーレ", calories: 850, protein_g: 35, fat_g: 24, carbs_g: 120, salt_g: 4.3, tags: ["パスタ", "海鮮", "トマト", "麺量カスタム可", "店員確認:標準茹で上がり250g", "大盛り1.5倍"], serving_label: "標準 茹で上がり250g" }),
  item({ brand: "マンマパスタ", name: "ボロネーゼ", calories: 820, protein_g: 31, fat_g: 30, carbs_g: 106, salt_g: 3.7, tags: ["パスタ", "ミートソース", "麺量カスタム可", "店員確認:標準茹で上がり250g", "大盛り1.5倍"], serving_label: "標準 茹で上がり250g" }),
  item({ brand: "マンマパスタ", name: "カルボナーラ", calories: 900, protein_g: 30, fat_g: 44, carbs_g: 92, salt_g: 3.5, tags: ["パスタ", "クリーム", "麺量カスタム可", "店員確認:標準茹で上がり250g", "大盛り1.5倍"], serving_label: "標準 茹で上がり250g" }),
  item({ brand: "マンマパスタ", name: "ペペロンチーノ", calories: 680, protein_g: 18, fat_g: 26, carbs_g: 94, salt_g: 3.1, tags: ["パスタ", "ペペロンチーノ", "麺量カスタム可", "店員確認:標準茹で上がり250g", "大盛り1.5倍"], serving_label: "標準 茹で上がり250g" }),
  item({ brand: "マンマパスタ", name: "渡り蟹のトマトクリーム", calories: 880, protein_g: 31, fat_g: 36, carbs_g: 104, salt_g: 3.8, tags: ["パスタ", "蟹", "クリーム", "麺量カスタム可", "店員確認:標準茹で上がり250g", "大盛り1.5倍"], serving_label: "標準 茹で上がり250g" }),
  item({ brand: "マンマパスタ", name: "明太子クリーム", calories: 820, protein_g: 27, fat_g: 34, carbs_g: 100, salt_g: 4.0, tags: ["パスタ", "明太子", "クリーム", "麺量カスタム可", "店員確認:標準茹で上がり250g", "大盛り1.5倍"], serving_label: "標準 茹で上がり250g" }),
